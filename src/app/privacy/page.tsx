...
export const metadata: Metadata = {
  title: "Privacy Policy | Stratoshub",
  description:
    "How PT Semesta Harsa Karya (Stratoshub) collects, uses, and protects personal and client project information across our website and engagements.",
};
      ...
      <main className="flex flex-1 flex-col">
        <section className="bg-cream-100 bg-noise px-6 pb-4 pt-20 text-center">
          ...
          <p className="mx-auto mt-6 max-w-xl text-navy-900/70">
            This Privacy Policy explains how PT Semesta Harsa Karya (Stratoshub) collects,
            uses, and protects your information across our website and engagements.
          </p>
          <p className="mt-4 font-mono-tight text-xs text-navy-900/40">
            Effective January 2025 · Document No. SHK-POL-022
          </p>
        </section>
        ...
        <section className="bg-cream-100 px-6 py-16">
          <div className="mx-auto flex max-w-3xl flex-col gap-6">
            ...
            <div className="rounded-xl bg-navy-900/5 px-6 py-4 text-sm text-navy-900/70">
              ...
              For any questions regarding this Privacy Policy or to exercise your data
